					...
					<div className="col-xl-3 col-sm-6 m-t35">
						<div className="card card-coin">
							<div className="card-body text-center">
								...
								<h2 className="text-black mb-2 font-w600">16839</h2>
								<p className="mb-0 fs-14">
									
									<span className="text-success mr-1"></span>Users
								</p>	
							</div>
						</div>
					</div>
						...
						<div className="card card-coin">
							<div className="card-body text-center">
								...
								<p className="mb-0 fs-13">
									...
									<span className="text-success mr-1"></span>Deposits
								</p>	
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-sm-6 m-t35">
						<div className="card card-coin">
							<div className="card-body text-center">
								...
								<h2 className="text-black mb-2 font-w600">124</h2>
								<p className="mb-0 fs-14">
									
									<span className="text-danger mr-1"></span>Games
								</p>	
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-sm-6 m-t35">
						<div className="card card-coin">
							<div className="card-body text-center">
								...
								<h2 className="text-black mb-2 font-w600">1224</h2>
								<p className="mb-0 fs-14">
									
									<span className="text-success mr-1"></span>Active Users
								</p>	
							</div>
						</div>
					</div>
					...
					<div className="col-xl-9 col-xxl-8">
						<div className="card">
							<div className="card-header border-0 flex-wrap pb-0 select-btn">
								<div className="mb-3">
									<h4 className="fs-20 text-black">Betting Overview</h4>
								...
								<div className="d-flex flex-wrap mb-2">
									<div className="custom-control check-switch custom-checkbox mr-4 mb-2">
										...
										<label className="custom-control-label" for="customCheck9">
											<span className="d-block  font-w500 mt-2">Dice</span>
										</label>
									</div>
									<div className="custom-control check-switch custom-checkbox mr-4 mb-2">
										...
										<label className="custom-control-label" for="customCheck91">
											<span className="d-block  font-w500 mt-2">Poker</span>
										</label>
									</div>
									<div className="custom-control check-switch custom-checkbox mr-4 mb-2">
										...
										<label className="custom-control-label" for="customCheck92">
											<span className="d-block font-w500 mt-2">Blackjack</span>
										</label>
									</div>
									<div className="custom-control check-switch custom-checkbox mr-4 mb-2">
										...
										<label className="custom-control-label" for="customCheck93">
											<span className="d-block font-w500 mt-2">Roulette</span>
										</label>
									</div>
								</div>
								<Dropdown>
								...
								<div className="chart-content">	
									<div className="d-flex justify-content-between mb-2 align-items-center">
										<div>
											...
											<span className="fs-14">Today Income</span>
										</div>
										<div>
									...
									<div className="d-flex justify-content-between mb-2 align-items-center">
										<div>
											...
											<span className="fs-14">Monthly Income</span>
										</div>
										<div>
					...
					<div className="col-xl-6 col-xxl-12">
						<div className="row">
							<div className="col-sm-6">
								<div className="card">
									<div className="card-header border-0 pb-0">
										<h4 className="mb-0 fs-20 text-black">Active Bettings</h4>
							...
							<div className="col-sm-6">
								<div className="card">
									<div className="card-header border-0 pb-0">
										<h4 className="mb-0 text-black fs-20">Betting Results</h4>
										<Dropdown className="dropdown custom-dropdown mb-0 tbl-orders-style">
											<Dropdown.Toggle variant="" className="btn sharp tp-btn i-false" data-toggle="dropdown">
												<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
							...
							<div className="col-xl-12 mt-2">
								<div className="card">
									<div className="card-header d-sm-flex d-block pb-0 border-0">
										<div>
											<h4 className="fs-20 text-black">Create Quick Games</h4>
										...
										<div className="basic-form">
											<form className="form-wrapper">
												<div className="form-group">
													<div className="input-group input-group-lg">
														<div className="input-group-prepend">
															<span className="input-group-text">Select Game</span>
														</div>
												...
												<div className="form-group">
													<div className="input-group input-group-lg">
														<div className="input-group-prepend">
															<span className="input-group-text ">Minimum Betting</span>
														</div>
												...
												<div className="form-group">
													<div className="input-group input-group-lg">
														<div className="input-group-prepend">
															<span className="input-group-text">Max betting</span>
														</div>
														<input type="number" className="form-control" placeholder="0,000000" />
													</div>
												</div>
						...
						<div className="row">
							...
							<div className="col-xl-12 mt-2">
								<div className="card">
									<div className="card-header d-sm-flex d-block pb-0 border-0">
										<div>
											<h4 className="fs-20 text-black">Send Notification for new game events</h4>
											<p className="mb-0 fs-12">Lorem ipsum dolor sit amet, consectetur</p>
										</div>
										<Dropdown className="custom-dropdown d-block mt-3 mt-sm-0 mb-0">
											<Dropdown.Toggle variant="" className="btn border border-warning btn-sm d-flex align-items-center svg-btn i-false" data-toggle="dropdown">
									...
									<div className="card-body">
										<div className="form-wrapper">
											<div className="form-group">
												<div className="input-group input-group-lg">
													...
													<input type="number" className="form-control" placeholder="Lorem ipsum dolor sit amet, consectetur" />
												</div>
											</div>
										</div>
										...
										<div className="row pt-sm-5 pt-3 align-items-center">
											...
											<div className="col-sm-6">
												<Link to={"#"} className="btn btn-secondary d-block btn-lg">SEND NOW</Link>
											</div>
										</div>
									</div>
								</div>
